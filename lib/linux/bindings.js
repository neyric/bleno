...
BlenoBindings.prototype.sendLeConnParamUpdateReq = function () {
  ...
  data.writeUInt8(0x01, 1); // Need to randomize? Sequential?

  data.writeUInt16LE(0x0008, 2); // LE_CON_PARAM_UPDATE_LEN
  data.writeUInt16LE(0x0258, 4); // Min. interval
  data.writeUInt16LE(0x0320, 6); // Max. interval
  data.writeUInt16LE(0x0000, 8); // Slave latency
  data.writeUInt16LE(0x0258, 10); // Timeout Multiplier


  this._aclStream.writeAclDataPkt(this._handle, LE_CHANNEL_CID, data);
};
