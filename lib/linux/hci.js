...
Hci.prototype.setAdvertisingParameters = function() {
  ...
  debug('writing setAdvertisingParameters: ' + cmd.toString('hex'));
...
Hci.prototype.setAdvertisingData = function(data) {
  ...
  debug('writing setAdvertisingData: ' + cmd.toString('hex'));
  this._socket.write(cmd);
};
...
Hci.prototype.setScanResponseData = function(data) {
  ...
  debug('writing setScanResponseData: ' + cmd.toString('hex'));
  this._socket.write(cmd);
};
...
Hci.prototype.setAdvertiseEnable = function(enabled) {
  ...
  debug('writing setAdvertiseEnable: ' + cmd.toString('hex'));
  this._socket.write(cmd);
};
...
Hci.prototype.disconnect = function(handle, reason) {
  ...
  debug('writing disconnect: ' + cmd.toString('hex'));
  this._socket.write(cmd);
};
...
Hci.prototype.readRssi = function(handle) {
  ...
  debug('writing readRssi: ' + cmd.toString('hex'));
  this._socket.write(cmd);
};
...
Hci.prototype.writeAclDataPkt = function(handle, cid, data) {
  ...
  debug('writing writeAclDataPkt: ' + pkt.toString('hex'));
